...
export const PHARMACY_PARTNERS: PharmacyPartner[] = [
  {
    id: 'ph1',
    name: 'Partner Pharmacy A',
    type: '503A',
    legitScriptUrl: 'https://www.legitscript.com',
    fdaRegistration: 'REG123456',
    eligibilityUrl: 'https://example.com/eligibility?ref=glp1guide&source=alternatives',
    priceMin: 150,
    priceMax: 280,
    form: 'injection',
    hsaFsaEligible: true,
  ...
  {
    id: 'ph2',
    name: 'Partner Pharmacy B',
    type: '503B',
    legitScriptUrl: 'https://www.legitscript.com',
    fdaRegistration: 'REG789012',
    eligibilityUrl: 'https://example.com/check?ref=glp1guide&source=alternatives',
    priceMin: 199,
    priceMax: 350,
    form: 'both',
    hsaFsaEligible: true,
  ...
  {
    id: 'ph3',
    name: 'Telehealth + Pharmacy C',
    type: '503A',
    legitScriptUrl: 'https://www.legitscript.com',
    fdaRegistration: 'REG345678',
    eligibilityUrl: 'https://example.com/start?ref=glp1guide&source=alternatives',
    priceMin: 249,
    priceMax: 399,
    form: 'oral',
    hsaFsaEligible: true,
  ...
  {
    id: 'ph4',
    name: 'Partner Pharmacy D',
    type: '503A',
    legitScriptUrl: 'https://www.legitscript.com',
    fdaRegistration: 'REG456789',
    eligibilityUrl: 'https://example.com/d?ref=glp1guide&source=alternatives',
    priceMin: 299,
    priceMax: 450,
    form: 'injection',
    hsaFsaEligible: true,
  ...
  {
    id: 'ph5',
    name: 'Telehealth + Pharmacy E',
    type: '503A',
    legitScriptUrl: 'https://www.legitscript.com',
    fdaRegistration: 'REG567890',
    eligibilityUrl: 'https://example.com/e?ref=glp1guide&source=alternatives',
    priceMin: 179,
    priceMax: 320,
    form: 'both',
    hsaFsaEligible: true,
